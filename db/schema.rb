...
ActiveRecord::Schema.define(version: 20150423010216) do
  ...
  create_table "commodities", primary_key: "code", force: true do |t|
    t.string   "name"
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  create_table "test_usernames", force: true do |t|
    t.string   "name"
    t.text     "description"
    t.string   "picture"
    t.datetime "created_at"
